...
the 90th percentile as burn severity extremes.

The independent variables used our analyses were SFD, SFDR, TRI, DC, stand age, canopy closure and
total aboveground biomass.

For stand structure, we produced an estimate of stand age , canopy closure and total average biomass
for each fire perimeter by calculating the mean value of all pixels within an individual fire event.
