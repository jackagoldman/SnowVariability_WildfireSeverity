...
be inconsequential compared to the amount of live fuel. Since snow free date can be hetergeneous
across a fire perimeter because of the direct effects of forest structure on snow accumulation and
sublimation [@schneiderTreeSpatialPatterns2019, @rothForestImpactsSnow2017,
...
Taken together with their direct effects on burn severity extermes, it is possible that while the
amount of live fuel (forest structure) may increase burn severity extremes, it may simultaneously
decrease the influence of snow free date by altering snow accumulation and sublimation.

Whereas at the ecoregional scale, snow free date has no direct relationship with either median or
extreme burn severity. However, snow free duration has opposing effects on median and extreme burn
severity at both the ecozone and ecoregional scale, increasing extreme burn severity but decreasing
median burn severity. At the ecoregion scale,
...
#burn severity ext
sem_ext <- readRDS("results/results-summary-tables/Table-1-sem-ext-ont.rds")

tbl <- sem_table(sem_ext)
tbl
```
