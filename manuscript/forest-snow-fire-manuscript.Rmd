...
interannual effects. The strength of the direct vs. indirect effects were measured using the
standardized regression coeffiecents. Overall model structure and goodness of fit was evaluated
using Shipley\'s test of directed separation [@shipley2009] and Fischer's C-statistic for pSEM
[@shipley.douma2020].
...
the standardized regression coefficients. We begun by testing our hypothesized causal structure on
the entire boreal shield ecoregion of Ontario. Although there is significant variation in climate
and weather patterns across the
