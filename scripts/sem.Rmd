...
# boostrap total effects - 10000 times
 med.full.sem.boot <- bootEff(sem_med_2_eff, R = 10000, seed = 429, parallel = "no") # failed with NA warning
...
#
#tidy table
modsum <- summary(west_sem_ext)$coefficients
modsum$Estimate <- round(modsum$Estimate, 3)
modsum$Std.Error <- round(modsum$Std.Error, 3)
modsum$Crit.Value <- round(modsum$Crit.Value, 3)
modsum$P.Value <- round(modsum$P.Value, 3)
...
colnames(modsum)[4:8] <- c("SE", "DF", "t-Value", "P-Value", "Std. Estimate")
modsum %>% kable()
write.csv(modsum, "results/results-summary-tables/Table_S3.csv")
...
#
#tidy table
modsum_wse <- summary(west_sem_med)$coefficients
modsum_wse$Estimate <- round(modsum_wse$Estimate, 3)
modsum_wse$Std.Error <- round(modsum_wse$Std.Error, 3)
modsum_wse$Crit.Value <- round(modsum_wse$Crit.Value, 3)
modsum_wse$P.Value <- round(modsum_wse$P.Value, 3)
modsum_wse$P.Value <- ifelse(modsum_wse$P.Value<0.001, "<0.001", modsum_wse$P.Value)
modsum_wse$Std.Estimate <- round(modsum_wse$Std.Estimate, 3)
modsum_wse$Response <- gsub("_", " ", modsum_wse$Response)
modsum_wse$Predictor <- gsub("_", " ", modsum_wse$Predictor)
colnames(modsum_wse)[4:8] <- c("SE", "DF", "t-Value", "P-Value", "Std. Estimate")
modsum_wse %>% kable()
write.csv(modsum_wse, "results/results-summary-tables/Table_S4.csv")
...
modsum_ee %>% kable()
write.csv(modsum_ee, "results/results-summary-tables/Table_S5.csv")
...
modsum_em %>% kable()
write.csv(modsum_em, "results/results-summary-tables/Table_S6.csv")
