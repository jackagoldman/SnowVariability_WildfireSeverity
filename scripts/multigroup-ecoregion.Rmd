...
ind.mult.ext <- matrix(c("Stand Age", "Total Aboveground Biomass", "Canopy Closure",
                         "Stand Age", "Total Aboveground Biomass", "Canopy Closure",
...
```{r}
names <- c("Indirect Pathway", "Path Coefficient", "Ecoregion")
ind.mult.med <- matrix(c("Stand Age", "Total Aboveground Biomass", "Canopy Closure",
                         "Stand Age", "Total Aboveground Biomass", "Canopy Closure",
                         ind.path.age.g1, ind.path.age.g2, ind.path.bio.g1, ind.path.bio.g2, 
...
theme_bw()+
  ...
  labs(title = "Median Burn Severity - East/West Multigroup")
...
theme_bw()+
  ...
  theme(legend.position ="bottom") + xlab("Standardized Effects")+
  scale_colour_viridis_d("Ecoregion", option = "viridis") +
  labs(title = "Burn Severity Extremes - East/West Multigroup")
